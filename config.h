...
static Shortcut shortcuts[] = {
    ...
    /* Also support Alt+Shift arrows/page for zoom (Luke-style) */
    { Mod1Mask|ShiftMask,   XK_Up,          zoom,           {.f = +1} },
    { Mod1Mask|ShiftMask,   XK_Down,        zoom,           {.f = -1} },
    ...
    { Mod1Mask|ShiftMask,   XK_U,           zoom,           {.f = +2} },
